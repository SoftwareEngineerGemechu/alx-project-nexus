  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-24 mb-16">
        ...
        {categories.map((category) => (
          ...
          >
            <div className="h-48 relative overflow-hidden bg-gray-100">
              ...
              />
              <div className="absolute bottom-0 right-0 left-0 h-12 bg-gradient-to-t from-white to-transparent "></div>
            </div>
            <div className="p-6">
              <h3
                className="text-xl font-bold mb-2 text-[#003d5b] group-hover:text-[#00789c
              ] transition-colors"
      ...
      <div className="mt-12 pt-12 border-t border-gray-200">
        <Link
          href="/"
          className="inline-flex items-center text-[#00789c] hover:text-[#003d5b] transition-colors"
        >
